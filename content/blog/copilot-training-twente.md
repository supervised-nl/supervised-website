...
Een inspiratiesessie kan een goede start zijn. Mensen zien wat Copilot kan en krijgen taal voor de mogelijkheden. Maar daarna moet je door naar toepassing.

Voorbeelden per rol:

- Sales: klantgesprekken voorbereiden, opvolgmails maken, offertes aanscherpen.
- HR: vacatureteksten verbeteren, beleid begrijpelijker maken, gespreksvragen voorbereiden.
- Administratie: Excel-overzichten laten uitleggen, standaardmails verbeteren, procedures structureren.
- Management: vergaderingen voorbereiden, besluiten samenvatten, interne updates opzetten.

Copilot levert pas iets op wanneer zulke taken terugkeren in het werk, niet wanneer iemand een keer een leuke prompt probeert.

## Let op SharePoint en Teams

Microsoft 365 Copilot werkt met informatie waar een gebruiker toegang toe heeft. Daardoor worden bestaande rechten en documentstructuren belangrijker.

Als Teams en SharePoint rommelig zijn ingericht, kan Copilot verkeerde of verouderde informatie gebruiken. Of informatie zichtbaar maken die technisch al toegankelijk was, maar praktisch nooit werd gevonden.
...
- een opvolgmoment om gebruik te evalueren.

Dat maakt training onderdeel van adoptie.
