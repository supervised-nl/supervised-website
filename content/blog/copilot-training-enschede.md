...
## Wat maakt een training praktisch?

Een praktische training gebruikt voorbeelden uit het werk. Niet alleen "schrijf een prompt", maar:

- bereid een klantgesprek voor;
- maak een opvolgmail na een Teams-overleg;
- herschrijf een offerte naar duidelijkere klanttaal;
- vat een document samen voor een collega;
- maak van notulen een actielijst;
- laat een Excel-overzicht uitleggen;
- verbeter een interne instructie of HR-tekst.

Daarbij hoort ook het gesprek over grenzen. Copilot kan helpen, maar output moet gecontroleerd worden. Zeker bij klantafspraken, persoonsgegevens, prijzen, contracten en beleid.

## Eerst duidelijkheid over Copilot en Copilot Chat

Veel medewerkers gebruiken de namen door elkaar. Microsoft 365 Copilot, Copilot Chat en losse AI-tools voelen voor een gebruiker soms hetzelfde, maar ze werken niet hetzelfde.

In een training moet daarom helder zijn:

- welke Copilot-versie jullie gebruiken;
- welke licenties actief zijn;
- welke informatie Copilot wel en niet kan gebruiken;
- welke tools binnen het bedrijf zijn toegestaan;
- waar medewerkers terechtkunnen met twijfelgevallen.

Die helderheid verlaagt de drempel. Mensen gebruiken AI sneller als ze weten wat de bedoeling is.

## Wanneer eerst een Readiness-scan nodig is
